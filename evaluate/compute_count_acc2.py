...
gold_file = "../new_model_softmax_decoder2/test_output_"+sys.argv[1]+"/true_sent.txt"#sys.argv[1]
pred_file = "../new_model_softmax_decoder2/test_output_"+sys.argv[1]+"/pred_sent.txt" #sys.argv[2]
...
for goldline, predline in zip(goldlines,predlines):	
		...
		if gold_number1==pred_number1 and gold_entity1==pred_entity1 and gold_number2==pred_number2 and gold_entity2==pred_entity2:
                        ...
                        acc=acc+1.0
		'''	
		if gold_number1==pred_number1 and gold_number2==pred_number2:
			acc=acc+1.0
		elif gold_number1==pred_number2 and gold_number2==pred_number1:
                        acc=acc+1.0
		elif gold_number1 is not None and gold_number1==pred_number1 and gold_number2 is None:
                        acc=acc+1.0
		elif gold_number1 is not None and gold_number1==pred_number1 and gold_entity1==pred_entity1 and gold_number2 is not None:# and sys.argv[1]=='15':
                        acc=acc+0.5
		elif gold_number1 is not None and gold_number1==pred_number2 and gold_number2 is None:
                        acc=acc+1.0
                elif gold_number1 is not None and gold_number1==pred_number2 and gold_number2 is not None:# and sys.argv[1]=='15':
                	acc=acc+0.5	
		elif gold_number1==pred_number1 and gold_number2 is None:
			acc=acc+1.0
		elif gold_number1==pred_number2 and gold_number2 is None:
			acc=acc+1.0
		'''	
